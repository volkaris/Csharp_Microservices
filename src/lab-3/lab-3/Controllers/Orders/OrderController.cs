...
public class OrderController : ControllerBase
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        OrderItemDto orderItemDto = await _orderService.AddProductToOrder(orderDto, productDto, quantity, cancellationToken);
        ...
        CancellationToken cancellationToken)
    {
        ...
        await _orderService.DeleteProductFromOrder(orderDto, productDto, cancellationToken);
        ...
        CancellationToken cancellationToken)
    {
        ...
        await _orderService.ChangeOrderStateToProcessing(orderDto, cancellationToken);
        ...
        CancellationToken cancellationToken)
    {
        ...
        await _orderService.CompleteOrder(orderDto, cancellationToken);
        ...
        CancellationToken cancellationToken)
    {
        ...
        await _orderService.CancelOrder(orderDto, cancellationToken);

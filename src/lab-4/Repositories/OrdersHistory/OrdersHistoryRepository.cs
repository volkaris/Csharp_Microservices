...
public class OrdersHistoryRepository : IOrdersHistoryRepository
{
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        ...
        while (await reader.ReadAsync(cancellationToken))
        {
            ...
            OrderHistoryBaseType payloadAsBaseType = JsonSerializer.Deserialize<OrderHistoryBaseType>(payloadAsJson) ??
                                                     throw new ArgumentNullException(nameof(payloadAsBaseType), "order payload can't be null");

    ...
    public void GetUpExpressions(IMigrationContext context)
    {
        context.Expressions.Add(new ExecuteSqlStatementExpression
        {
            SqlStatement = """
                           ...
                           create type order_state as enum ('created', 'processing', 'completed', 'cancelled','unspecified');
                           ...
                           create type order_history_item_kind as enum ('created', 'item_added', 'item_removed', 'state_changed','unspecified');
